...
while True:
    ...
    if re.search('hello', res):
        print('Hello Shaif what can i do for you?')
        t2s('Hello Shaif what can i do for you')
    ...
    if re.search('what can you do', res):
        li_commands = {
            ...
            "tell me": "Example: 'tell me about Suriname'",
            "weather": "Example: 'what weather/temperature in Suriname?'",
